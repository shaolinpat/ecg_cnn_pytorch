...
# Covers
# ------
#     - load_ptbxl_full(): small subsample to keep runtime reasonable
#     - load_ptbxl_sample(): 100-record subset loader

# Notes
# -----
# These tests are skipped unless both PTBXL_DATA_DIR and PROJECT_ROOT/data/sample
# exist locally. They print basic shapes and label summaries for manual
# inspection.
# """
